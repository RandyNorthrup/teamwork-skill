...
- Added deterministic allowlisted release packaging from immutable Git blobs for clean cross-platform builds, double-captured development source provenance, recoverable ZIP/sidecar publication, exact installed-byte verification, fully bound SPDX 2.3 SBOM verification and official validation, and transactional install/upgrade/transfer/uninstall guidance.
